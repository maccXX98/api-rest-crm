...
export class InitDB1775415030471 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer_order_detail" DROP COLUMN "customerOrderCustomerOrderID"`);
        await queryRunner.query(`ALTER TABLE "customer_order_detail" DROP COLUMN "productProductID"`);
        await queryRunner.query(`ALTER TABLE "city" ADD "variations" text`);
        await queryRunner.query(`ALTER TABLE "city" ADD "cashOnDelivery" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "payment_method" ADD "variations" text`);
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ALTER COLUMN "CustomerOrderID" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ALTER COLUMN "ProductID" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ALTER COLUMN "ProductID" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ALTER COLUMN "CustomerOrderID" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payment_method" DROP COLUMN "variations"`);
        ...
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ADD "productProductID" integer`);
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ADD "customerOrderCustomerOrderID" integer`);
        ...
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ADD CONSTRAINT "FK_5d49fc6e0d2f37c5ef96fe726d8" FOREIGN KEY ("productProductID") REFERENCES "product"("ProductID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "customer_order_detail" ADD CONSTRAINT "FK_2d4f1d84a1f7825c208aefca7ce" FOREIGN KEY ("customerOrderCustomerOrderID") REFERENCES "customer_order"("CustomerOrderID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
